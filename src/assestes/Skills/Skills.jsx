...
import zero from 'src/assestes/Skills/photos/download (1).png';
import one from 'src/assestes/Skills/photos/download (1).png';
import two from 'src/assestes/Skills/photos/download (1).png';
